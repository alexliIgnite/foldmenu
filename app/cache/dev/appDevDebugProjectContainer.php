...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'coreingredients.service' => 'getCoreingredients_ServiceService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'appmainBundle', ($this->targetDirs[2].'/Resources/appmainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'appmainBundle', ($this->targetDirs[3].'/src/app/mainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'coreingredients.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \core\assetBundle\Service\ingredientsService A core\assetBundle\Service\ingredientsService instance.
     */
    protected function getCoreingredients_ServiceService()
    {
        return $this->services['coreingredients.service'] = new \core\assetBundle\Service\ingredientsService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_CoreConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.core_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dev.db.asset.foldmenu.com', 'port' => NULL, 'dbname' => 'fmAsset', 'user' => 'root', 'password' => 'cdadmin14', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/core/userBundle/Entity'), 1 => ($this->targetDirs[3].'/src/core/assetBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'core\\userBundle\\Entity');
        $c->addDriver($b, 'core\\assetBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('coreuserBundle' => 'core\\userBundle\\Entity', 'coreassetBundle' => 'core\\assetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_38c232d9060d489e75da115effb0deb093683785fa4d5ece9c0db254f77d2796');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_EttrackingMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_etTracking_38c232d9060d489e75da115effb0deb093683785fa4d5ece9c0db254f77d2796');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'appmainBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/core/assetBundle/Resources/views'), 'coreasset');
        $instance->addPath(($this->targetDirs[3].'/src/app/mainBundle/Resources/views'), 'appmain');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('570344cecfd1c')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'coreassetBundle' => 'core\\assetBundle\\coreassetBundle',
                'appmainBundle' => 'app\\mainBundle\\appmainBundle',
            ...
            'database_host' => 'dev.db.asset.foldmenu.com',
            'database_port' => NULL,
            'database_name' => 'fmAsset',
            'database_user' => 'root',
            'database_password' => 'cdadmin14',
            ...
            'database_host_t' => 'dev.db.asset.foldmenu.com',
            'database_port_t' => NULL,
            'database_name_t' => 'fmAsset',
            'database_user_t' => 'root',
            'database_password_t' => 'cdadmin14',
